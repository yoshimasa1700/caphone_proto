...
static void window_load(Window *window) {
  ...
  text_layer_set_background_color(hour_text, GColorBlack);
  text_layer_set_text_color(hour_text, GColorWhite);
  ...
  text_layer_set_background_color(minute_text, GColorBlack);
  text_layer_set_text_color(minute_text, GColorWhite);
  ...
  text_layer_set_background_color(second_text, GColorBlack);
  text_layer_set_text_color(second_text, GColorWhite);
